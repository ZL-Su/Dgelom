...
DGE_BEGIN namespace detail{ namespace impl {
#ifndef HOST_INL_CXPR_T
#define HOST_INL_CXPR_T __forceinline constexpr auto
#endif
#ifndef HOST_STATIC_INL_CXPR_T
#define HOST_STATIC_INL_CXPR_T static __forceinline constexpr auto 
#endif

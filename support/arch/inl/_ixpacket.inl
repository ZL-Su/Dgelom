...
#include "../ixpacket.h"
DGE_BEGIN
template<typename T, int _Elems> DGE_HOST_FINL
...
DGE_HOST_FINL Packet operator+ (const Packet_<T, _N>& _Left, const Packet_<T, _N>& _Right)
{
